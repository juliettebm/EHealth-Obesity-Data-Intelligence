...
This repository contains an end-to-end data analytics project combining **SQL Server** for structural database cleaning and **Python** for statistical modeling and exploratory visualization.
...
3. **Statistical Engine (SciPy):** Conducted hypothesis testing to validate the biological significance of behavioral metrics.

---

## 🔍 Analytical Core & Scientific Findings
